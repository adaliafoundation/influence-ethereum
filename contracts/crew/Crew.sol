...
// NOTE: This is actual "CREW" contract, not to be confused with the CrewToken which represents crewmates.
 ...
 */
contract Crew is ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, AccessControlUpgradeable, OwnableUpgradeable, ERC721PausableUpgradeable {
  ...
  */
  ...
  /**
   * @dev Allowed managers (including sale contract) can mint
