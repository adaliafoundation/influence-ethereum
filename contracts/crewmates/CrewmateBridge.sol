...
import "../interfaces/ICrewmateToken.sol";
import "../interfaces/IStarknetCore.sol";
import "../lib/InfluenceRoles.sol";
import "../lib/InfluenceUtils.sol";

// TODO: change payload to include sender
...
contract CrewmateBridge is AccessControlUpgradeable, OwnableUpgradeable {
  ...
  function finishBridgeToStarknetCancellation(
    ...
    // Re-mint assets
    for (uint i = 0; i < payload[1]; i += 2) {
      l1CrewmateTokenContract.mint(origSender, payload[i + 2]);
    }
