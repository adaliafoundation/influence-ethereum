...
/**
 * @dev Contract that models each ship as an ERC721, non-fungible token.
 */
contract Ship is ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, AccessControlUpgradeable, OwnableUpgradeable, ERC721PausableUpgradeable {
